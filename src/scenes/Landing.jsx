...
const Landing = ({ setSelectedPage }) => {
  ...
  return (
    <section
      id="home"
      className="md:flex md:justify-between md:items-center gap-16 md:h-full py-10 h-100%"
    >
      {/* IMAGE SECTION */}
        ...
        {isAboveLarge ? (
          ...
          >
            <img
              alt="profile"
              className="
              hover:filter hover:saturate-200 transition duration-500 z-10 w-full max-h-[600px] md:max-h-[600px] rounded-t-[400px]"
        ...
        >
          <p className="text-6xl font-playfair z-10 text-center md:text-start">
            ...
            <span
              ...
              before:absolute before:-left-[5px] before:-top-[70px] before:z-[-1]"
            >
              Jamsranjav
            </span>
          </p>
